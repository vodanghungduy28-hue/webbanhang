    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <p class="banner-text">Mua sắm tiện lợi, giao hàng nhanh, giá tốt mỗi ngày. Khám phá bộ sưu tập điện thoại, laptop và phụ kiện giá cạnh tranh.</p>
                <div class="mt-4">
        ...
        <div class="card-body">
            <form method="get" action="/webbanhang/Product/" class="row g-3 align-items-end">
                <div class="col-md-5">
                    ...
                    <input type="text" id="search" name="search" value="<?php echo isset($search) ? htmlspecialchars($search, ENT_QUOTES, 'UTF-8') : ''; ?>" class="form-control form-control-lg" placeholder="Nhập tên sản phẩm...">
                </div>
                <div class="col-md-5">
